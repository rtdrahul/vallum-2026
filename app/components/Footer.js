        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <img
              ...
              alt={siteSettings?.site_title ? `${siteSettings.site_title} logo` : "Vallum Capital logo"}
            />
            ...
            <div style={{ display: "flex", gap: "8px", marginTop: "12px" }}>
              {siteSettings?.linkedin_url && (
                <a className="social-link" aria-label="Visit our linkedin profile" title="Visit our LinkedIn profile" href={siteSettings.linkedin_url} target="_blank" rel="noopener noreferrer" style={{ width: "20px", height: "20px", borderRadius: "8px" }}>
              ...
              {siteSettings?.twitter_url && (
                <a className="social-link" aria-label="Visit our twitter profile" title="Visit our Twitter profile" href={siteSettings.twitter_url} target="_blank" rel="noopener noreferrer" style={{ width: "20px", height: "20px", borderRadius: "8px" }}>
              ...
              {siteSettings?.youtube_url && (
                <a className="social-link" aria-label="Visit our youtube channel" title="Visit our YouTube channel" href={siteSettings.youtube_url} target="_blank" rel="noopener noreferrer" style={{ width: "20px", height: "20px", borderRadius: "8px" }}>
